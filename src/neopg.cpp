...
struct version : cli::command<version> {
  ...
  static const char* help() { return "output version information and exit"; }

  void run() { printf("NeoPG 0.0\n"); }
};
...
struct gpg2 : cli::command<gpg2> {
  ...
  static const char* help() { return "Invoke gpg2"; }
...
struct agent : cli::command<agent> {
  ...
  static const char* help() { return "Invoke agent"; }
...
struct dirmngr : cli::command<dirmngr> {
  ...
  static const char* help() { return "Invoke dirmngr"; }
...
struct gpgsm : cli::command<gpgsm> {
  ...
  static const char* help() { return "Invoke gpgsm"; }
...
struct scd : cli::command<scd> {
  ...
  static const char* help() { return "Invoke scd"; }
...
struct dirmngr_client : cli::command<dirmngr_client> {
  ...
  static const char* help() { return "Invoke dirmngr_client"; }

  void run() {
    dirmngr_client_args.insert(dirmngr_client_args.begin(),
                               std::string("dirmngr_client"));
    int argc = dirmngr_client_args.size();
    std::vector<char*> argv;
    for (auto&& value : dirmngr_client_args)
      argv.push_back((char*)value.data());
    // Return value
