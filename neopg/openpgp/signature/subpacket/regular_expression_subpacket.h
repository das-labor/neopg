// OpenPGP regular expression subpacket
...
/// [regular expression](https://tools.ietf.org/html/rfc4880#section-5.2.3.6)
/// subpacket.
class NEOPG_UNSTABLE_API RegularExpressionSubpacket
 ...
 public:
  ...
  /// Create new regular expression subpacket from \p input. Throw an exception
  /// on error.
  ///
  ...
  ///
  /// \return the value SignatureSubpacketType::RegularExpression
  SignatureSubpacketType type() const noexcept override {
    return SignatureSubpacketType::RegularExpression;
  }

  /// Construct a new regular expression subpacket.
  RegularExpressionSubpacket() = default;
};
