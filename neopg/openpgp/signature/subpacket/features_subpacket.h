...
class NEOPG_UNSTABLE_API FeaturesSubpacket : public SignatureSubpacket {
 public:
  ...
  /// The parser limit for the size of #m_features. Any packet larger than that
  /// will cause a ParserError.
  static const size_t MAX_LENGTH = 2048;

  /// Create new features subpacket from \p input. Throw
  ...
  ///
  /// \return the value SignatureSubpacketType::Features
  SignatureSubpacketType type() const noexcept override {
    return SignatureSubpacketType::Features;
  }

  /// Construct a new features subpacket.
  FeaturesSubpacket() = default;
};
