...
typedef enum { PKALGO_RSA, PKALGO_DSA, PKALGO_ECC } pkalgo_t;
...
static const struct algo_table_s pk_algo_table[] = {
    ...
    {                        /* iso.member-body.us.rsadsi.pkcs.pkcs-1.1 */
     ...
     "\x2a\x86\x48\x86\xf7\x0d\x01\x01\x01", 9, 1, PKALGO_RSA, "rsa", "-ne",
     "\x30\x02\x02"},

    {                        /* iso.member-body.us.rsadsi.pkcs.pkcs-1.7 */
     "1.2.840.113549.1.1.7", /* RSAES-OAEP */
     "\x2a\x86\x48\x86\xf7\x0d\x01\x01\x07", 9, 0, PKALGO_RSA, "rsa", "-ne",
     "\x30\x02\x02"}, /* (patent problems) */

    {             /* */
     "2.5.8.1.1", /* rsa (ambiguous due to missing padding rules)*/
     "\x55\x08\x01\x01", 4, 1, PKALGO_RSA, "ambiguous-rsa", "-ne",
     "\x30\x02\x02"},

    {                     /* iso.member-body.us.x9-57.x9cm.1 */
     "1.2.840.10040.4.1", /*  dsa */
     "\x2a\x86\x48\xce\x38\x04\x01", 7, 1, PKALGO_DSA, "dsa", "y", "\x02",
     "-pqg", "\x30\x02\x02\x02"},

    {                     /* iso.member-body.us.ansi-x9-62.2.1 */
     "1.2.840.10045.2.1", /*  ecPublicKey */
     "\x2a\x86\x48\xce\x3d\x02\x01", 7, 1, PKALGO_ECC, "ecc", "q", "\x80"},
...
static const struct algo_table_s sig_algo_table[] = {
    {                        /* iso.member-body.us.rsadsi.pkcs.pkcs-1.5 */
     ...
     "\x2A\x86\x48\x86\xF7\x0D\x01\x01\x05", 9, 1, PKALGO_RSA, "rsa", "s",
     "\x82", NULL, NULL, "sha1"},
    {                        /* iso.member-body.us.rsadsi.pkcs.pkcs-1.4 */
     "1.2.840.113549.1.1.4", /* md5WithRSAEncryption */
     "\x2A\x86\x48\x86\xF7\x0D\x01\x01\x04", 9, 1, PKALGO_RSA, "rsa", "s",
     "\x82", NULL, NULL, "md5"},
    {                        /* iso.member-body.us.rsadsi.pkcs.pkcs-1.2 */
     "1.2.840.113549.1.1.2", /* md2WithRSAEncryption */
     "\x2A\x86\x48\x86\xF7\x0D\x01\x01\x02", 9, 0, PKALGO_RSA, "rsa", "s",
     "\x82", NULL, NULL, "md2"},
    {                     /* iso.member-body.us.x9-57.x9cm.1 */
     "1.2.840.10040.4.3", /* dsa */
     "\x2a\x86\x48\xce\x38\x04\x01", 7, 1, PKALGO_DSA, "dsa", "-rs",
     "\x30\x02\x02"},
    {                     /* iso.member-body.us.x9-57.x9cm.3 */
     "1.2.840.10040.4.3", /*  dsaWithSha1 */
     "\x2a\x86\x48\xce\x38\x04\x03", 7, 1, PKALGO_DSA, "dsa", "-rs",
     "\x30\x02\x02", NULL, NULL, "sha1"},
    {                    /* Teletrust signature algorithm.  */
     "1.3.36.8.5.1.2.2", /* dsaWithRIPEMD160 */
     "\x2b\x24\x08\x05\x01\x02\x02", 7, 1, PKALGO_DSA, "dsa", "-rs",
     "\x30\x02\x02", NULL, NULL, "rmd160"},
    {                          /* NIST Algorithm */
     "2.16.840.1.101.3.4.3.1", /* dsaWithSha224 */
     "\x06\x09\x60\x86\x48\x01\x65\x03\x04\x03\x01", 11, 1, PKALGO_DSA, "dsa",
     "-rs", "\x30\x02\x02", NULL, NULL, "sha224"},
    {/* NIST Algorithm (the draft also used .1 but we better use .2) */
     "2.16.840.1.101.3.4.3.2", /* dsaWithSha256 */
     "\x06\x09\x60\x86\x48\x01\x65\x03\x04\x03\x01", 11, 1, PKALGO_DSA, "dsa",
     "-rs", "\x30\x02\x02", NULL, NULL, "sha256"},

    {/* iso.member-body.us.ansi-x9-62.signatures.ecdsa-with-sha1 */
     "1.2.840.10045.4.1", /*  ecdsa */
     "\x2a\x86\x48\xce\x3d\x04\x01", 7, 1, PKALGO_ECC, "ecdsa", "-rs",
     "\x30\x02\x02", NULL, NULL, "sha1"},

    {/* iso.member-body.us.ansi-x9-62.signatures.ecdsa-with-specified */
     "1.2.840.10045.4.3", "\x2a\x86\x48\xce\x3d\x04\x03", 7, 1, PKALGO_ECC,
     "ecdsa", "-rs", "\x30\x02\x02", NULL, NULL, NULL},
    /* The digest algorithm is given by the parameter.  */

    {/* iso.member-body.us.ansi-x9-62.signatures.ecdsa-with-sha224 */
     "1.2.840.10045.4.3.1", "\x2a\x86\x48\xce\x3d\x04\x03\x01", 8, 1,
     PKALGO_ECC, "ecdsa", "-rs", "\x30\x02\x02", NULL, NULL, "sha224"},

    {/* iso.member-body.us.ansi-x9-62.signatures.ecdsa-with-sha256 */
     "1.2.840.10045.4.3.2", "\x2a\x86\x48\xce\x3d\x04\x03\x02", 8, 1,
     PKALGO_ECC, "ecdsa", "-rs", "\x30\x02\x02", NULL, NULL, "sha256"},

    {/* iso.member-body.us.ansi-x9-62.signatures.ecdsa-with-sha384 */
     "1.2.840.10045.4.3.3", "\x2a\x86\x48\xce\x3d\x04\x03\x03", 8, 1,
     PKALGO_ECC, "ecdsa", "-rs", "\x30\x02\x02", NULL, NULL, "sha384"},

    {/* iso.member-body.us.ansi-x9-62.signatures.ecdsa-with-sha512 */
     "1.2.840.10045.4.3.4", "\x2a\x86\x48\xce\x3d\x04\x03\x04", 8, 1,
     PKALGO_ECC, "ecdsa", "-rs", "\x30\x02\x02", NULL, NULL, "sha512"},

    {                        /* iso.member-body.us.rsadsi.pkcs.pkcs-1.1 */
     "1.2.840.113549.1.1.1", /* rsaEncryption used without hash algo*/
     "\x2a\x86\x48\x86\xf7\x0d\x01\x01\x01", 9, 1, PKALGO_RSA, "rsa", "s",
     "\x82"},
    {/* from NIST's OIW - actually belongs in a pure hash table */
     "1.3.14.3.2.26", /* sha1 */
     "\x2B\x0E\x03\x02\x1A", 5, 0, PKALGO_RSA, "sha-1", "", "", NULL, NULL,
     "sha1"},

    {                  /* As used by telesec cards */
     "1.3.36.3.3.1.2", /* rsaSignatureWithripemd160 */
     "\x2b\x24\x03\x03\x01\x02", 6, 1, PKALGO_RSA, "rsa", "s", "\x82", NULL,
     NULL, "rmd160"},

    {                 /* from NIST's OIW - used by TU Darmstadt */
     "1.3.14.3.2.29", /* sha-1WithRSAEncryption */
     "\x2B\x0E\x03\x02\x1D", 5, 1, PKALGO_RSA, "rsa", "s", "\x82", NULL, NULL,
     "sha1"},

    {                         /* from PKCS#1  */
     "1.2.840.113549.1.1.11", /* sha256WithRSAEncryption */
     "\x2a\x86\x48\x86\xf7\x0d\x01\x01\x0b", 9, 1, PKALGO_RSA, "rsa", "s",
     "\x82", NULL, NULL, "sha256"},

    {                         /* from PKCS#1  */
     "1.2.840.113549.1.1.12", /* sha384WithRSAEncryption */
     "\x2a\x86\x48\x86\xf7\x0d\x01\x01\x0c", 9, 1, PKALGO_RSA, "rsa", "s",
     "\x82", NULL, NULL, "sha384"},

    {                         /* from PKCS#1  */
     "1.2.840.113549.1.1.13", /* sha512WithRSAEncryption */
     "\x2a\x86\x48\x86\xf7\x0d\x01\x01\x0d", 9, 1, PKALGO_RSA, "rsa", "s",
     "\x82", NULL, NULL, "sha512"},
    ...
    {/* TeleTrust signature scheme with RSA signature and DSI according
     ...
     "\x2B\x24\x03\x04\x03\x02\x02", 7, 0, PKALGO_RSA, "rsa", "s", "\x82", NULL,
     NULL, "rmd160"},
...
static const struct algo_table_s enc_algo_table[] = {
    {                        /* iso.member-body.us.rsadsi.pkcs.pkcs-1.1 */
     "1.2.840.113549.1.1.1", /* rsaEncryption (RSAES-PKCA1-v1.5) */
     "\x2A\x86\x48\x86\xF7\x0D\x01\x01\x01", 9, 1, PKALGO_RSA, "rsa", "a",
     "\x82"},
    {NULL}};
...
static const struct {
  const char *oid;
  const char *name;
} curve_names[] = {{"1.3.6.1.4.1.3029.1.5.1", "Curve25519"},
...
#define TLV_LENGTH(prefix)                             \
  do {                                                 \
    if (!prefix##len) return GPG_ERR_INV_KEYINFO;      \
    c = *(prefix)++;                                   \
    prefix##len--;                                     \
    if (c == 0x80) return GPG_ERR_NOT_DER_ENCODED;     \
    if (c == 0xff) return GPG_ERR_BAD_BER;             \
                                                       \
    if (!(c & 0x80))                                   \
      len = c;                                         \
    else {                                             \
      ...
      for (len = 0; count; count--) {                  \
        len <<= 8;                                     \
        if (!prefix##len) return GPG_ERR_BAD_BER;      \
        c = *(prefix)++;                               \
        prefix##len--;                                 \
        len |= c & 0xff;                               \
      }                                                \
    }                                                  \
    if (len > prefix##len) return GPG_ERR_INV_KEYINFO; \
  } while (0)
...
static unsigned char *get_ecc_curve_oid(const unsigned char *buf, size_t buflen,
                                        size_t *r_oidlen) {
  ...
  if (buflen && !digitp(buf)) {
    ...
    for (i = 0; curve_names[i].oid; i++)
      if (buflen == strlen(curve_names[i].name) &&
        ...
        break;
    if (!curve_names[i].oid) return NULL; /* Not found.  */
    buf = (const unsigned char *)curve_names[i].oid;
    buflen = strlen(curve_names[i].oid);
  }

  if (_ksba_oid_from_buf(buf, buflen, &der_oid, r_oidlen)) return NULL;
  return der_oid;
}
...
/* Return the OFF and the LEN of algorithm within DER.  Do some checks
   ...
   mode 1: as described.
 */
static gpg_error_t get_algorithm(int mode, const unsigned char *der,
                                 size_t derlen, size_t *r_nread, size_t *r_pos,
                                 size_t *r_len, int *r_bitstr,
  ...
  *r_bitstr = 0;
  if (r_parm_pos) *r_parm_pos = 0;
  if (r_parm_len) *r_parm_len = 0;
  if (r_parm_type) *r_parm_type = 0;
  /* get the inner sequence */
  if (!derlen) return GPG_ERR_INV_KEYINFO;
  c = *der++;
  derlen--;
  if (c != 0x30) return GPG_ERR_UNEXPECTED_TAG; /* not a SEQUENCE */
  TLV_LENGTH(der);
  seqlen = len;
  startseq = der;
  ...
  c = *der++;
  derlen--;
  if (c != 0x06) return GPG_ERR_UNEXPECTED_TAG; /* not an OBJECT IDENTIFIER */
  TLV_LENGTH(der);
  ...
  *r_len = len;
  ...
  if (seqlen) {
    ...
    if (c == 0x05) {
      ...
      *r_parm_len = len;
      ...
      if (r_parm_type) *r_parm_type = TYPE_OBJECT_ID;
      TLV_LENGTH(der);
      *r_parm_pos = der - start;
      *r_parm_len = len;
      seqlen -= der - startparm;
      ...
      /*  This is a sequence. */
      if (r_parm_type) *r_parm_type = TYPE_SEQUENCE;
      TLV_LENGTH(der);
  ...
  if (seqlen) return GPG_ERR_INV_KEYINFO;
  ...
  if (mode) {
    ...
    if (c == 0x03)
      *r_bitstr = 1; /* BIT STRING */
      ...
      return GPG_ERR_UNEXPECTED_TAG; /* not a BIT STRING */
    TLV_LENGTH(der);
  }
...
gpg_error_t _ksba_parse_algorithm_identifier(const unsigned char *der,
                                             ...
                                             char **r_oid) {
  return _ksba_parse_algorithm_identifier2(der, derlen, r_nread, r_oid, NULL,
                                           NULL);
}
...
gpg_error_t _ksba_parse_algorithm_identifier2(const unsigned char *der,
  ...
  *r_nread = 0;
  off2 = len2 = 0;
  err = get_algorithm(0, der, derlen, &nread, &off, &len, &is_bitstr, &off2,
                      &len2, &parm_type);
  if (err) return err;
  *r_nread = nread;
  *r_oid = ksba_oid_to_str((const char *)(der + off), len);
  if (!*r_oid) return GPG_ERR_ENOMEM;
...
static void init_stringbuf(struct stringbuf *sb, int initiallen) {
  ...
  if (!sb->buf) sb->out_of_core = 1;
}

static void put_stringbuf_mem(struct stringbuf *sb, const char *text,
                              size_t n) {
  if (sb->out_of_core) return;
...
static void put_stringbuf_mem_sexp(struct stringbuf *sb, const char *text,
                                   size_t length) {
  char buf[20];
...
gpg_error_t _ksba_keyinfo_to_sexp(const unsigned char *der, size_t derlen,
  ...
  *r_string = NULL;
  ...
  err = get_algorithm(1, der, derlen, &nread, &off, &len, &is_bitstr, &parm_off,
                      &parm_len, &parm_type);
  if (err) return err;
  ...
  if (!pk_algo_table[algoidx].oid) return GPG_ERR_UNKNOWN_ALGORITHM;
  if (!pk_algo_table[algoidx].supported) return GPG_ERR_UNSUPPORTED_ALGORITHM;
  ...
  if (is_bitstr) { /* Funny: X.509 defines the signature value as a bit string
                      but
                      CMS as an octet string - for ease of implementation we
                      always
                      allow both */
    if (!derlen) {
      xfree(parm_oid);
      return GPG_ERR_INV_KEYINFO;
    }
    c = *der++;
    derlen--;
    if (c) fprintf(stderr, "warning: number of unused bits is not zero\n");
  }
  ...
  /* If parameters are given and we have a description for them, parse
     them. */
  if (parmder && parmderlen && pk_algo_table[algoidx].parmelem_string &&
  ...
  *r_string = (ksba_sexp_t)get_stringbuf(&sb);
  if (!*r_string) return GPG_ERR_ENOMEM;
...
static const unsigned char *oid_from_buffer(const unsigned char *buf,
                                            int buflen, int *oidlen,
  ...
  if (with_sig) {
    ...
    for (i = 0; sig_algo_table[i].oid; i++) {
      if (!sig_algo_table[i].supported) continue;
  ...
  for (i = 0; pk_algo_table[i].oid; i++) {
    if (!pk_algo_table[i].supported) continue;
  ...
  if (!pk_algo_table[i].oid) return NULL;
...
gpg_error_t _ksba_keyinfo_from_sexp(ksba_const_sexp_t sexp,
  ...
  if (!sexp) return GPG_ERR_INV_VALUE;
  ...
  s++;
  if (n != 10 || memcmp(s, "public-key", 10)) return GPG_ERR_UNKNOWN_SEXP;
  s += 10;
  ...
  if (!oid) return GPG_ERR_UNSUPPORTED_ALGORITHM;
  s += n;

  /* Collect all the values */
  for (parmidx = 0; *s != ')'; parmidx++) {
    if (parmidx >= DIM(parm)) return GPG_ERR_GENERAL;
    if (*s != '(') return digitp(s) ? GPG_ERR_UNKNOWN_SEXP : GPG_ERR_INV_SEXP;
    s++;
    n = strtoul((const char *)(s), &endp, 10);
    s = (const unsigned char *)endp;
    ...
    s += n;
    if (!digitp(s)) return GPG_ERR_UNKNOWN_SEXP; /* ... or invalid S-Exp. */
    ...
    s += n;
    if (*s != ')') return GPG_ERR_UNKNOWN_SEXP; /* ... or invalid S-Exp. */
    s++;
  }
  s++;
  ...
  if (idxtbllen != strlen(parmdesc)) return GPG_ERR_UNKNOWN_SEXP;

  if (pkalgo == PKALGO_ECC) {
    curve_oid = get_ecc_curve_oid(parm[idxtbl[0]].value,
                                  parm[idxtbl[0]].valuelen, &curve_oidlen);
    if (!curve_oid) return GPG_ERR_UNKNOWN_SEXP;
  }
  ...
  if (pkalgo == PKALGO_ECC) {
    ...
    err = _ksba_ber_write_tl(writer, TYPE_BIT_STRING, CLASS_UNIVERSAL, 0,
                             parm[idxtbl[1]].valuelen + 1);
    if (!err) err = ksba_writer_write(writer, "", 1);
  ...
  if (algoparmdesc) {
    ...
    if (idxtbllen != strlen(algoparmdesc)) return GPG_ERR_UNKNOWN_SEXP;
  ...
  if (algoparmseq_len) {
    ...
    n += _ksba_ber_count_tl(TYPE_OBJECT_ID, CLASS_UNIVERSAL, 0, curve_oidlen);
    n += curve_oidlen;
  ...
  if (!err) err = ksba_writer_write(writer, oid, oidlen);
  if (err) goto leave;
  ...
  if (algoparmseq_len) {
    ...
    err = _ksba_ber_write_tl(writer, TYPE_OBJECT_ID, CLASS_UNIVERSAL, 0,
                             curve_oidlen);
    if (!err) err = ksba_writer_write(writer, curve_oid, curve_oidlen);
  } else if (pkalgo == PKALGO_RSA) {
...
static gpg_error_t cryptval_to_sexp(int mode, const unsigned char *der,
                                    size_t derlen, ksba_sexp_t *r_string) {
  gpg_error_t err;
  ...
  *r_string = NULL;
  ...
  err = get_algorithm(1, der, derlen, &nread, &off, &len, &is_bitstr, NULL,
                      NULL, NULL);
  if (err) return err;
  ...
  if (!algo_table[algoidx].oid) return GPG_ERR_UNKNOWN_ALGORITHM;
  if (!algo_table[algoidx].supported) return GPG_ERR_UNSUPPORTED_ALGORITHM;
  ...
  for (; *elem; ctrl++, elem++) {
    ...
    if ((*ctrl & 0x80) && !elem[1]) { /* Hack to allow a raw value */
      is_int = 1;
      len = derlen;
    } else {
      if (!derlen) return GPG_ERR_INV_KEYINFO;
      c = *der++;
      derlen--;
      if (c != *ctrl) return GPG_ERR_UNEXPECTED_TAG;
      is_int = c == 0x02;
      TLV_LENGTH(der);
    }
    if (is_int && *elem != '-') { /* take this integer */
