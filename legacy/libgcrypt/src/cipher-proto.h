...
typedef gpg_error_t (*selftest_func_t)(int algo, int extended,
...
typedef gpg_error_t (*gcry_pk_sign_t)(gcry_sexp_t *r_sig, gcry_sexp_t s_data,
                                      gcry_sexp_t keyparms);

/* Type for the pk_verify function.  */
typedef gpg_error_t (*gcry_pk_verify_t)(gcry_sexp_t s_sig, gcry_sexp_t s_data,
                                        gcry_sexp_t keyparms);
...
typedef gpg_error_t (*pk_comp_keygrip_t)(gcry_md_hd_t md, gcry_sexp_t keyparm);
...
typedef gpg_error_t (*gcry_cipher_setkey_t)(void *c, const unsigned char *key,
                                            unsigned keylen);
...
typedef gpg_error_t (*cipher_set_extra_info_t)(void *c, int what,
                                               const void *buffer,
                                               size_t buflen);
...
typedef struct gcry_md_oid_spec { const char *oidstring; } gcry_md_oid_spec_t;
