...
static void check_dsa_rfc6979(void) {
  static struct {
    const char *name;
    const char *key;
  } keys[] = {
  ...
  static struct {
    ...
    const char *k, *r, *s;
      ...
      {"DSA, 1024 bits", "With SHA-1, message = \"sample\"", "sha1", "sample",
       "7BDB6B0FF756E1BB5D53583EF979082F9AD5BD5B",
       "2E1A0C2562B2912CAAF89186FB0F42001585DA55",
       "29EFB6B0AFF2D7A68EB70CA313022253B9A88DF5"},
      {"DSA, 1024 bits", "With SHA-224, message = \"sample\"", "sha224",
       "sample", "562097C06782D60C3037BA7BE104774344687649",
       "4BC3B686AEA70145856814A6F1BB53346F02101E",
       "410697B92295D994D21EDD2F4ADA85566F6F94C1"},
      {"DSA, 1024 bits", "With SHA-256, message = \"sample\"", "sha256",
       "sample", "519BA0546D0C39202A7D34D7DFA5E760B318BCFB",
       "81F2F5850BE5BC123C43F71A3033E9384611C545",
       "4CDD914B65EB6C66A8AAAD27299BEE6B035F5E89"},
      {"DSA, 1024 bits", "With SHA-384, message = \"sample\"", "sha384",
      ...
      {"DSA, 2048 bits", "With SHA-224, message = \"sample\"", "sha224",
       "sample",
      ...
      {"DSA, 2048 bits", "With SHA-256, message = \"sample\"", "sha256",
       "sample",
      ...
      {"DSA, 2048 bits", "With SHA-384, message = \"sample\"", "sha384",
       "sample",
      ...
      {"DSA, 2048 bits", "With SHA-512, message = \"sample\"", "sha512",
       "sample",
      ...
      {"DSA, 2048 bits", "With SHA-1, message = \"test\"", "sha1", "test",
      ...
      {"DSA, 2048 bits", "With SHA-224, message = \"test\"", "sha224", "test",
      ...
      {"DSA, 2048 bits", "With SHA-256, message = \"test\"", "sha256", "test",
      ...
      {"DSA, 2048 bits", "With SHA-384, message = \"test\"", "sha384", "test",
      ...
      {"DSA, 2048 bits", "With SHA-512, message = \"test\"", "sha512", "test",
      ...
      {"ECDSA, 192 bits (prime field)", "With SHA-1, message = \"sample\"",
       "sha1", "sample", "37D7CA00D2C7B0E5E412AC03BD44BA837FDD5B28CD3B0021",
       "98C6BD12B23EAF5E2A2045132086BE3EB8EBD62ABF6698FF",
       "57A22B07DEA9530F8DE9471B1DC6624472E8E2844BC25B64"},
      {"ECDSA, 192 bits (prime field)", "With SHA-224, message = \"sample\"",
       "sha224", "sample", "4381526B3FC1E7128F202E194505592F01D5FF4C5AF015D8",
       "A1F00DAD97AEEC91C95585F36200C65F3C01812AA60378F5",
       "E07EC1304C7C6C9DEBBE980B9692668F81D4DE7922A0F97A"},
      {"ECDSA, 192 bits (prime field)", "With SHA-256, message = \"sample\"",
       "sha256", "sample", "32B1B6D7D42A05CB449065727A84804FB1A3E34D8F261496",
       "4B0B8CE98A92866A2820E20AA6B75B56382E0F9BFD5ECB55",
       "CCDB006926EA9565CBADC840829D8C384E06DE1F1E381B85"},
      {"ECDSA, 192 bits (prime field)", "With SHA-384, message = \"sample\"",
       "sha384", "sample", "4730005C4FCB01834C063A7B6760096DBE284B8252EF4311",
       "DA63BF0B9ABCF948FBB1E9167F136145F7A20426DCC287D5",
       "C3AA2C960972BD7A2003A57E1C4C77F0578F8AE95E31EC5E"},
      {"ECDSA, 192 bits (prime field)", "With SHA-512, message = \"sample\"",
       "sha512", "sample", "A2AC7AB055E4F20692D49209544C203A7D1F2C0BFBC75DB1",
       "4D60C5AB1996BD848343B31C00850205E2EA6922DAC2E4B8",
       "3F6E837448F027A1BF4B34E796E32A811CBB4050908D8F67"},
      {"ECDSA, 192 bits (prime field)", "With SHA-1, message = \"test\"",
       "sha1", "test", "D9CF9C3D3297D3260773A1DA7418DB5537AB8DD93DE7FA25",
       "0F2141A0EBBC44D2E1AF90A50EBCFCE5E197B3B7D4DE036D",
       "EB18BC9E1F3D7387500CB99CF5F7C157070A8961E38700B7"},
      {"ECDSA, 192 bits (prime field)", "With SHA-224, message = \"test\"",
       "sha224", "test", "F5DC805F76EF851800700CCE82E7B98D8911B7D510059FBE",
       "6945A1C1D1B2206B8145548F633BB61CEF04891BAF26ED34",
       "B7FB7FDFC339C0B9BD61A9F5A8EAF9BE58FC5CBA2CB15293"},
      {"ECDSA, 192 bits (prime field)", "With SHA-256, message = \"test\"",
       "sha256", "test", "5C4CE89CF56D9E7C77C8585339B006B97B5F0680B4306C6C",
       "3A718BD8B4926C3B52EE6BBE67EF79B18CB6EB62B1AD97AE",
       "5662E6848A4A19B1F1AE2F72ACD4B8BBE50F1EAC65D9124F"},
      {"ECDSA, 192 bits (prime field)", "With SHA-384, message = \"test\"",
       "sha384", "test", "5AFEFB5D3393261B828DB6C91FBC68C230727B030C975693",
       "B234B60B4DB75A733E19280A7A6034BD6B1EE88AF5332367",
       "7994090B2D59BB782BE57E74A44C9A1C700413F8ABEFE77A"},
      {"ECDSA, 192 bits (prime field)", "With SHA-512, message = \"test\"",
       "sha512", "test", "0758753A5254759C7CFBAD2E2D9B0792EEE44136C9480527",
       "FE4F4AE86A58B6507946715934FE2D8FF9D95B6B098FE739",
       "74CF5605C98FBA0E1EF34D4B5A1577A7DCF59457CAE52290"},

      {"ECDSA, 224 bits (prime field)", "With SHA-1, message = \"sample\"",
       "sha1", "sample",
      ...
      {"ECDSA, 224 bits (prime field)", "With SHA-224, message = \"sample\"",
       "sha224", "sample",
      ...
      {"ECDSA, 224 bits (prime field)", "With SHA-256, message = \"sample\"",
       "sha256", "sample",
      ...
      {"ECDSA, 224 bits (prime field)", "With SHA-384, message = \"sample\"",
       "sha384", "sample",
      ...
      {"ECDSA, 224 bits (prime field)", "With SHA-512, message = \"sample\"",
       "sha512", "sample",
      ...
      {"ECDSA, 224 bits (prime field)", "With SHA-1, message = \"test\"",
       "sha1", "test",
      ...
      {"ECDSA, 224 bits (prime field)", "With SHA-224, message = \"test\"",
       "sha224", "test",
      ...
      {"ECDSA, 224 bits (prime field)", "With SHA-256, message = \"test\"",
       "sha256", "test",
      ...
      {"ECDSA, 224 bits (prime field)", "With SHA-384, message = \"test\"",
       "sha384", "test",
      ...
      {"ECDSA, 224 bits (prime field)", "With SHA-512, message = \"test\"",
       "sha512", "test",
      ...
      {"ECDSA, 256 bits (prime field)", "With SHA-1, message = \"sample\"",
       "sha1", "sample",
      ...
      {"ECDSA, 256 bits (prime field)", "With SHA-224, message = \"sample\"",
       "sha224", "sample",
      ...
      {"ECDSA, 256 bits (prime field)", "With SHA-256, message = \"sample\"",
       "sha256", "sample",
       "A6E3C57DD01ABE90086538398355DD4C3B17AA873382B0F24D6129493D8AAD60",
       "EFD48B2AACB6A8FD1140DD9CD45E81D69D2C877B56AAF991C34D0EA84EAF3716",
       "F7CB1C942D657C41D436C7A1B6E29F65F3E900DBB9AFF4064DC4AB2F843ACDA8"},
      {"ECDSA, 256 bits (prime field)", "With SHA-384, message = \"sample\"",
       "sha384", "sample",
      ...
      {"ECDSA, 256 bits (prime field)", "With SHA-512, message = \"sample\"",
       "sha512", "sample",
      ...
      {"ECDSA, 256 bits (prime field)", "With SHA-1, message = \"test\"",
       "sha1", "test",
      ...
      {"ECDSA, 256 bits (prime field)", "With SHA-224, message = \"test\"",
       "sha224", "test",
      ...
      {"ECDSA, 256 bits (prime field)", "With SHA-256, message = \"test\"",
       "sha256", "test",
       "D16B6AE827F17175E040871A1C7EC3500192C4C92677336EC2537ACAEE0008E0",
       "F1ABB023518351CD71D881567B1EA663ED3EFCF6C5132B354F28D3B0B7D38367",
       "019F4113742A2B14BD25926B49C649155F267E60D3814B4C0CC84250E46F0083"},
      {"ECDSA, 256 bits (prime field)", "With SHA-384, message = \"test\"",
       "sha384", "test",
      ...
      {"ECDSA, 256 bits (prime field)", "With SHA-512, message = \"test\"",
       "sha512", "test",
      ...
      {"ECDSA, 384 bits (prime field)", "With SHA-1, message = \"sample\"",
       "sha1", "sample",
      ...
      {"ECDSA, 384 bits (prime field)", "With SHA-224, message = \"sample\"",
       "sha224", "sample",
      ...
      {"ECDSA, 384 bits (prime field)", "With SHA-256, message = \"sample\"",
       "sha256", "sample",
      ...
      {"ECDSA, 384 bits (prime field)", "With SHA-384, message = \"sample\"",
       "sha384", "sample",
      ...
      {"ECDSA, 384 bits (prime field)", "With SHA-512, message = \"sample\"",
       "sha512", "sample",
      ...
      {"ECDSA, 384 bits (prime field)", "With SHA-1, message = \"test\"",
       "sha1", "test",
      ...
      {"ECDSA, 384 bits (prime field)", "With SHA-224, message = \"test\"",
       "sha224", "test",
      ...
      {"ECDSA, 384 bits (prime field)", "With SHA-256, message = \"test\"",
       "sha256", "test",
      ...
      {"ECDSA, 384 bits (prime field)", "With SHA-384, message = \"test\"",
       "sha384", "test",
      ...
      {"ECDSA, 384 bits (prime field)", "With SHA-512, message = \"test\"",
       "sha512", "test",
      ...
      {"ECDSA, 521 bits (prime field)", "With SHA-1, message = \"sample\"",
       "sha1", "sample",
       ...
       "D16"},
      {"ECDSA, 521 bits (prime field)", "With SHA-224, message = \"sample\"",
       "sha224", "sample",
       ...
       "41F"},
      {"ECDSA, 521 bits (prime field)", "With SHA-256, message = \"sample\"",
       "sha256", "sample",
       ...
       "CFC"},
      {"ECDSA, 521 bits (prime field)", "With SHA-384, message = \"sample\"",
       "sha384", "sample",
       ...
       "D61"},
      {"ECDSA, 521 bits (prime field)", "With SHA-512, message = \"sample\"",
       "sha512", "sample",
       ...
       "67A"},
      {"ECDSA, 521 bits (prime field)", "With SHA-1, message = \"test\"",
       "sha1", "test",
       ...
       "7FF"},
      {"ECDSA, 521 bits (prime field)", "With SHA-224, message = \"test\"",
       "sha224", "test",
       ...
       "9A4"},
      {"ECDSA, 521 bits (prime field)", "With SHA-256, message = \"test\"",
       "sha256", "test",
       ...
       "E86"},
      {"ECDSA, 521 bits (prime field)", "With SHA-384, message = \"test\"",
       "sha384", "test",
       ...
       "979"},
      {"ECDSA, 521 bits (prime field)", "With SHA-512, message = \"test\"",
       "sha512", "test",
  ...
  for (tno = 0; tests[tno].keyname; tno++) {
...

    {
      for (i = 0; keys[i].name; i++)
        if (!strcmp(tests[tno].keyname, keys[i].name)) break;
      if (!keys[i].name)
        die("Key '%s' used by test '%s' not found\n", tests[tno].keyname,
            tests[tno].name);

      err = gcry_sexp_new(&seckey, keys[i].key, 0, 1);
      if (err) die("reading key failed: %s\n", gpg_strerror(err));
    }
    ...
    gcry_md_hash_buffer(hashalgo, digest, tests[tno].message,
                        strlen(tests[tno].message));
