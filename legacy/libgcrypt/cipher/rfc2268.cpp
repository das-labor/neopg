...
typedef struct { u16 S[64]; } RFC2268_context;
...
static gpg_error_t setkey_core(void *context, const unsigned char *key,
...
static gpg_error_t do_setkey(void *context, const unsigned char *key,
                             unsigned int keylen) {
