...
static unsigned int KECCAK_F1600_ABSORB_FUNC_NAME(KECCAK_STATE *hd, int pos,
                                                  const byte *lanes,
                                                  unsigned int nlanes,
                                                  int blocklanes) {
  unsigned int burn = 0;
    ...
    switch (blocklanes) {
      case 21:
        ...
        while (pos == 0 && nlanes >= 21) {
          nlanes -= 21;
          absorb_lanes64_8(&hd->u.state64[0], lanes);
          lanes += 8 * 8;
          absorb_lanes64_8(&hd->u.state64[8], lanes);
          lanes += 8 * 8;
          absorb_lanes64_4(&hd->u.state64[16], lanes);
          lanes += 8 * 4;
          absorb_lanes64_1(&hd->u.state64[20], lanes);
          lanes += 8 * 1;
      ...
      case 18:
        ...
        while (pos == 0 && nlanes >= 18) {
          ...
          absorb_lanes64_8(&hd->u.state64[8], lanes);
          lanes += 8 * 8;
          absorb_lanes64_2(&hd->u.state64[16], lanes);
          lanes += 8 * 2;
      ...
      case 17:
        ...
        while (pos == 0 && nlanes >= 17) {
          ...
          absorb_lanes64_8(&hd->u.state64[8], lanes);
          lanes += 8 * 8;
          absorb_lanes64_1(&hd->u.state64[16], lanes);
          lanes += 8 * 1;
      ...
      case 13:
        ...
        while (pos == 0 && nlanes >= 13) {
          ...
          absorb_lanes64_8(&hd->u.state64[0], lanes);
          lanes += 8 * 8;
          absorb_lanes64_4(&hd->u.state64[8], lanes);
          lanes += 8 * 4;
          absorb_lanes64_1(&hd->u.state64[12], lanes);
          lanes += 8 * 1;
      ...
      case 9:
        ...
        while (pos == 0 && nlanes >= 9) {
          ...
          absorb_lanes64_8(&hd->u.state64[0], lanes);
          lanes += 8 * 8;
          absorb_lanes64_1(&hd->u.state64[8], lanes);
          lanes += 8 * 1;
