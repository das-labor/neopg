...
static struct {
  ...
  const char *name;
    ...
    {850, "ibm850"},              /* OEM Multilingual Latin 1; Western
                                     European (DOS) */
    ...
    {863, "IBM863"},              /* OEM French Canadian; French Canadian
                                     (DOS) */
    {864, "IBM864"},              /* OEM Arabic; Arabic (864) */
    {865, "IBM865"},              /* OEM Nordic; Nordic (DOS) */
    {866, "cp866"},               /* OEM Russian; Cyrillic (DOS) */
    {869, "ibm869"},              /* OEM Modern Greek; Greek, Modern (DOS) */
    {870, "IBM870"},              /* IBM EBCDIC Multilingual/ROECE (Latin
                                     2); IBM EBCDIC Multilingual Latin 2 */
    {874, "windows-874"},         /* ANSI/OEM Thai (same as 28605, ISO
                                     8859-15); Thai (Windows) */
    {875, "cp875"},               /* IBM EBCDIC Greek Modern */
    {932, "shift_jis"},           /* ANSI/OEM Japanese; Japanese
                                     (Shift-JIS) */
    {932, "shift-jis"},           /* alternative name for it */
    {936, "gb2312"},              /* ANSI/OEM Simplified Chinese (PRC,
                                     Singapore); Chinese Simplified
                                     (GB2312) */
    {949, "ks_c_5601-1987"},      /* ANSI/OEM Korean (Unified
                                     Hangul Code) */
    {950, "big5"},                /* ANSI/OEM Traditional Chinese (Taiwan; Hong
                                     Kong SAR, PRC); Chinese Traditional (Big5) */
    {950, "big5hkscs"},           /* ANSI/OEM Traditional Chinese
                                     (Hong Kong SAR); Chinese
                                     Traditional (Big5-HKSCS) */
    {950, "big5-hkscs"},          /* alternative name for it */
    {1026, "IBM1026"},            /* IBM EBCDIC Turkish (Latin 5) */
    {1047, "IBM01047"},           /* IBM EBCDIC Latin 1/Open System */
    {1140, "IBM01140"},           /* IBM EBCDIC US-Canada (037 + Euro
                                     symbol); IBM EBCDIC
                                     (US-Canada-Euro) */
    {1141, "IBM01141"},           /* IBM EBCDIC Germany (20273 + Euro
                                     symbol); IBM EBCDIC (Germany-Euro) */
    {1142, "IBM01142"},           /* IBM EBCDIC Denmark-Norway (20277 +
                                     Euro symbol); IBM EBCDIC
                                     (Denmark-Norway-Euro) */
    {1143, "IBM01143"},           /* IBM EBCDIC Finland-Sweden (20278 +
                                     Euro symbol); IBM EBCDIC
                                     (Finland-Sweden-Euro) */
    {1144, "IBM01144"},           /* IBM EBCDIC Italy (20280 + Euro
                                     symbol); IBM EBCDIC (Italy-Euro) */
    {1145, "IBM01145"},           /* IBM EBCDIC Latin America-Spain
                                     (20284 + Euro symbol); IBM EBCDIC
                                     (Spain-Euro) */
    {1146, "IBM01146"},           /* IBM EBCDIC United Kingdom (20285 + Euro
                                     symbol); IBM EBCDIC (UK-Euro) */
    {1147, "IBM01147"},           /* IBM EBCDIC France (20297 + Euro
                                     symbol); IBM EBCDIC (France-Euro)
                                     */
    {1148, "IBM01148"},           /* IBM EBCDIC International (500 +
                                     Euro symbol); IBM EBCDIC
                                     (International-Euro) */
    {1149, "IBM01149"},           /* IBM EBCDIC Icelandic (20871 + Euro
                                     symbol); IBM EBCDIC (Icelandic-Euro) */
    {1250, "windows-1250"},       /* ANSI Central European; Central
                                     European (Windows) */
    {1251, "windows-1251"},       /* ANSI Cyrillic; Cyrillic (Windows) */
    {1252, "windows-1252"},       /* ANSI Latin 1; Western European
                                     (Windows) */
    ...
    {1258, "windows-1258"},       /* ANSI/OEM Vietnamese; Vietnamese
                                     (Windows) */
    ...
    {20000, "x-Chinese_CNS"},     /* CNS Taiwan; Chinese
                                     Traditional (CNS) */
    {20001, "x-cp20001"},         /* TCA Taiwan */
    {20002, "x_Chinese-Eten"},    /* Eten Taiwan; Chinese
                                     Traditional (Eten) */
    {20003, "x-cp20003"},         /* IBM5550 Taiwan */
    {20004, "x-cp20004"},         /* TeleText Taiwan */
    {20005, "x-cp20005"},         /* Wang Taiwan */
    {20105, "x-IA5"},             /* IA5 (IRV International Alphabet No.
                                     5, 7-bit); Western European (IA5) */
    ...
    {20833, "x-EBCDIC-KoreanExtended"}, /* IBM EBCDIC Korean
                                           Extended */
    ...
    {20924, "IBM00924"},  /* IBM EBCDIC Latin 1/Open System
                             (1047 + Euro symbol) */
    ...
    {28591, "iso-8859-1"}, /* ISO 8859-1 Latin 1; Western
                              European (ISO) */
    {28591, "iso8859-1"},  /* ISO 8859-1 Latin 1; Western
                              European (ISO) */
    {28591, "iso_8859-1"},
    {28591, "iso_8859_1"},
    {28592, "iso-8859-2"}, /* ISO 8859-2 Central European;
                              Central European (ISO) */
    {28592, "iso8859-2"},  /* ISO 8859-2 Central European;
                              Central European (ISO) */
    {28592, "iso_8859-2"},
    {28592, "iso_8859_2"},
    ...
    {28597, "iso_8859-7"},
    {28597, "iso_8859_7"},
    {28598, "iso-8859-8"}, /* ISO 8859-8 Hebrew; Hebrew
                              (ISO-Visual) */
    {28598, "iso8859-8"},  /* ISO 8859-8 Hebrew; Hebrew
                              (ISO-Visual) */
    {28598, "iso_8859-8"},
    {28598, "iso_8859_8"},
    ...
    {38598, "iso-8859-8-i"}, /* ISO 8859-8 Hebrew; Hebrew
                                (ISO-Logical) */
    {38598, "iso8859-8-i"},  /* ISO 8859-8 Hebrew; Hebrew
                                (ISO-Logical) */
    {38598, "iso_8859-8-i"},
    {38598, "iso_8859_8-i"},
    {50220, "iso-2022-jp"}, /* ISO 2022 Japanese with no
                               ...
                               (JIS) */
    {50221, "csISO2022JP"}, /* ISO 2022 Japanese with
                               halfwidth Katakana; Japanese
    ...
    /* 50935 		EBCDIC Simplified Chinese
       Extended and Simplified Chinese */
    /* 50936 		EBCDIC Simplified Chinese */
    /* 50937 		EBCDIC US-Canada and Traditional
       Chinese */
    /* 50939 		EBCDIC Japanese (Latin) Extended
       and Japanese */
    {51932, "euc-jp"}, /* EUC Japanese */
    {51936, "EUC-CN"}, /* EUC Simplified Chinese; Chinese
                          Simplified (EUC) */
    {51949, "euc-kr"}, /* EUC Korean */
    /* 51950 		EUC Traditional Chinese */
    {52936, "hz-gb-2312"}, /* HZ-GB2312 Simplified Chinese;
                              Chinese Simplified (HZ) */
    {54936, "GB18030"},    /* Windows XP and later: GB18030
                              Simplified Chinese (4 byte);
...
static int win_iconv_open(gpgrt_w32_iconv_t cd, const char *tocode,
                          const char *fromcode) {
...
static size_t win_iconv(gpgrt_w32_iconv_t cd, const char **inbuf,
...
static char *strrstr(const char *str, const char *token) {
  ...
  while (str <= --p)
    if (p[0] == token[0] && strncmp(p, token, len) == 0) return (char *)p;
  return NULL;
}
...
static int dbcs_mblen(csconv_t *cv, const uchar *buf, int bufsize) {
  ...
  if (bufsize < len) return seterror(EINVAL);
  return len;
}
...
static int kernel_wctomb(csconv_t *cv, ushort *wbuf, int wbufsize, uchar *buf,
  ...
  if (bufsize == 0) return seterror(E2BIG);
  ...
  if (len == 0) {
    if (GetLastError() == ERROR_INSUFFICIENT_BUFFER) return seterror(E2BIG);
    return seterror(EILSEQ);
...
static int mlang_mbtowc(csconv_t *cv, const uchar *buf, int bufsize,
  ...
  if (hr != S_OK || insize != len) return seterror(EILSEQ);
  return len;
}
...
static int utf16_mbtowc(csconv_t *cv, const uchar *buf, int bufsize,
  ...
  if (cv->mode & UNICODE_MODE_SWAPPED) codepage ^= 1;

  if (bufsize < 2) return seterror(EINVAL);
  ...
  if (0xDC00 <= wbuf[0] && wbuf[0] <= 0xDFFF) return seterror(EILSEQ);
  if (0xD800 <= wbuf[0] && wbuf[0] <= 0xDBFF) {
    if (bufsize < 4) return seterror(EINVAL);
    if (codepage == 1200) /* little endian */
      wbuf[1] = (buf[3] << 8) | buf[2];
    else if (codepage == 1201) /* big endian */
      wbuf[1] = (buf[2] << 8) | buf[3];
    if (!(0xDC00 <= wbuf[1] && wbuf[1] <= 0xDFFF)) return seterror(EILSEQ);
    *wbufsize = 2;
    return 4;
  }
  *wbufsize = 1;
...
static int utf16_wctomb(csconv_t *cv, ushort *wbuf, int wbufsize, uchar *buf,
  ...
  if ((cv->flags & FLAG_USE_BOM) && !(cv->mode & UNICODE_MODE_BOM_DONE)) {
    ...
    cv->mode |= UNICODE_MODE_BOM_DONE;
    if (bufsize < 2) return seterror(E2BIG);
  ...
  if (0xD800 <= wbuf[0] && wbuf[0] <= 0xDBFF) {
    if (bufsize < 4) return seterror(E2BIG);
    if (cv->codepage == 1200) /* little endian */
    {
      buf[2] = (wbuf[1] & 0x00FF);
...
static int utf32_mbtowc(csconv_t *cv, const uchar *buf, int bufsize,
  ...
  if ((0xD800 <= wc && wc <= 0xDFFF) || 0x10FFFF < wc) return seterror(EILSEQ);
...
static int iso2022jp_mbtowc(csconv_t *cv, const uchar *buf, int bufsize,
  ...
  if (bufsize < len) return seterror(EINVAL);
  for (i = 0; i < len; ++i)
    if (!(buf[i] < 0x80)) return seterror(EILSEQ);
  ...
  hr = ConvertINetMultiByteToUnicode(&dummy, cv->codepage, (const char *)tmp,
                                     &insize, (wchar_t *)wbuf, wbufsize);
  if (hr != S_OK || insize != len + esc_len) return seterror(EILSEQ);
...
static int iso2022jp_wctomb(csconv_t *cv, ushort *wbuf, int wbufsize,
  ...
  if (tmpsize == 1) {
    ...
    if (iesc[i].esc == NULL) /* not supported escape sequence */
      return seterror(EILSEQ);
  }
  ...
  if (bufsize < len + esc_len) return seterror(E2BIG);
...
static int iso2022jp_flush(csconv_t *cv, uchar *buf, int bufsize) {
  ...
  if (cv->mode != ISO2022_MODE(ISO2022JP_CS_ASCII, ISO2022_SI)) {
    ...
    if (ISO2022_MODE_CS(cv->mode) != ISO2022JP_CS_ASCII)
      esc_len += iesc[ISO2022JP_CS_ASCII].esc_len;
    if (bufsize < esc_len) return seterror(E2BIG);
