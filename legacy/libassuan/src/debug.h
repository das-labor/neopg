...
void _assuan_debug(assuan_context_t ctx, unsigned int cat, const char *format,
                   ...);

/* Start a new debug line in *LINE, logged at level LEVEL or higher,
   and starting with the formatted string FORMAT.  */
void _assuan_debug_begin(assuan_context_t ctx, void **helper, unsigned int cat,
                         const char *format, ...);

/* Add the formatted string FORMAT to the debug line *LINE.  */
void _assuan_debug_add(assuan_context_t ctx, void **helper, const char *format,
                       ...);

/* Finish construction of *LINE and send it to the debug output
   stream.  */
void _assuan_debug_end(assuan_context_t ctx, void **helper, unsigned int cat);
...
#define TRACE_BEG(ctx, lvl, name, tag)                      \
  ...
  _assuan_debug(_assuan_trace_context, _assuan_trace_level, \
                "%s (%s=%p): enter\n", _assuan_trace_func,  \
                _assuan_trace_tagname, _assuan_trace_tag)
...
#define TRACE_BEG1(ctx, lvl, name, tag, fmt, arg1)                  \
  ...
  _assuan_debug(_assuan_trace_context, _assuan_trace_level,         \
                "%s (%s=%p): enter: " fmt "\n", _assuan_trace_func, \
                _assuan_trace_tagname, _assuan_trace_tag, arg1)
#define TRACE_BEG2(ctx, lvl, name, tag, fmt, arg1, arg2)            \
  _TRACE(ctx, lvl, name, tag);                                      \
  _assuan_debug(_assuan_trace_context, _assuan_trace_level,         \
                "%s (%s=%p): enter: " fmt "\n", _assuan_trace_func, \
                _assuan_trace_tagname, _assuan_trace_tag, arg1, arg2)
#define TRACE_BEG3(ctx, lvl, name, tag, fmt, arg1, arg2, arg3)      \
  _TRACE(ctx, lvl, name, tag);                                      \
  _assuan_debug(_assuan_trace_context, _assuan_trace_level,         \
                "%s (%s=%p): enter: " fmt "\n", _assuan_trace_func, \
                _assuan_trace_tagname, _assuan_trace_tag, arg1, arg2, arg3)
#define TRACE_BEG4(ctx, lvl, name, tag, fmt, arg1, arg2, arg3, arg4)        \
  ...
  _assuan_debug(_assuan_trace_context, _assuan_trace_level,                 \
                ...
                _assuan_trace_tagname, _assuan_trace_tag, arg1, arg2, arg3, \
                arg4)
#define TRACE_BEG6(ctx, lvl, name, tag, fmt, arg1, arg2, arg3, arg4, arg5,  \
                   arg6)                                                    \
  _TRACE(ctx, lvl, name, tag);                                              \
  _assuan_debug(_assuan_trace_context, _assuan_trace_level,                 \
                "%s (%s=%p): enter: " fmt "\n", _assuan_trace_func,         \
...
#define TRACE_BEG8(ctx, lvl, name, tag, fmt, arg1, arg2, arg3, arg4, arg5,  \
                   arg6, arg7, arg8)                                        \
  _TRACE(ctx, lvl, name, tag);                                              \
  _assuan_debug(_assuan_trace_context, _assuan_trace_level,                 \
                "%s (%s=%p): enter: " fmt "\n", _assuan_trace_func,         \
...
#define TRACE_LOGBUF(buf, len)                                      \
  _assuan_debug_buffer(_assuan_trace_context, _assuan_trace_level,  \
                       "%s (%s=%p): check: %s", _assuan_trace_func, \
                       _assuan_trace_tagname, _assuan_trace_tag, buf, len)

#define TRACE_SEQ(hlp, fmt)                                          \
  _assuan_debug_begin(_assuan_trace_context, &(hlp),                 \
                      "%s (%s=%p): check: " fmt, _assuan_trace_func, \
                      _assuan_trace_tagname, _assuan_trace_tag)
