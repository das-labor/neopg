...
#define ARGPARSE_op(s, l, t, d)                                                \
  {                                                                            \
    (s), (l),                                                                  \
        (ARGPARSE_TYPE_##t | ARGPARSE_OPT_OPTIONAL | ARGPARSE_OPT_PREFIX), (d) \
  }
#define ARGPARSE_op_n(s, l, d)                                              \
  {                                                                         \
    (s), (l),                                                               \
        (ARGPARSE_TYPE_NONE | ARGPARSE_OPT_OPTIONAL | ARGPARSE_OPT_PREFIX), \
        (d)                                                                 \
  }
#define ARGPARSE_op_i(s, l, d)                                                 \
  {                                                                            \
    (s), (l),                                                                  \
        (ARGPARSE_TYPE_INT | ARGPARSE_OPT_OPTIONAL | ARGPARSE_OPT_PREFIX), (d) \
  }
#define ARGPARSE_op_s(s, l, d)                                                \
  {                                                                           \
    (s), (l),                                                                 \
        (ARGPARSE_TYPE_STRING | ARGPARSE_OPT_OPTIONAL | ARGPARSE_OPT_PREFIX), \
        (d)                                                                   \
  }
#define ARGPARSE_op_l(s, l, d)                                              \
  {                                                                         \
    (s), (l),                                                               \
        (ARGPARSE_TYPE_LONG | ARGPARSE_OPT_OPTIONAL | ARGPARSE_OPT_PREFIX), \
        (d)                                                                 \
  }
#define ARGPARSE_op_u(s, l, d)                                               \
  {                                                                          \
    (s), (l),                                                                \
        (ARGPARSE_TYPE_ULONG | ARGPARSE_OPT_OPTIONAL | ARGPARSE_OPT_PREFIX), \
        (d)                                                                  \
  }
