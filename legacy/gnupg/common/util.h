...
unsigned char *make_simple_sexp_from_hexstr(const char *line, size_t *nscanned);
...
void print_hexstring(FILE *fp, const void *buffer, size_t length, int reserved);
...
static inline char *_gnupg_ttyname(int fd) {
  (void)fd;
  return NULL;
}
#else /*HAVE_TTYNAME*/
