...
gpg_error_t agent_pksign(ctrl_t ctrl, const char *cache_nonce,
                         const char *hexkeygrip, const char *desc, u32 *keyid,
...
gpg_error_t agent_keywrap_key(ctrl_t ctrl, int forexport, void **r_kek,
                              size_t *r_keklen);
...
gpg_error_t agent_export_key(ctrl_t ctrl, const char *keygrip, const char *desc,
